...
describe("JavaPrimitiveDecoder", () => {
  describe("decode()", () => {
    it("should decode a java int primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("int", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java long primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("long", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java double primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("double", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java float primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("float", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java boolean primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("boolean", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java byte primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("byte", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java short primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("short", DEFAULT_DECODER_SETTINGS);
    ...
    it("should decode a java char primitive correctly", () => {
      const decoder = new JavaPrimitiveDecoder("char", DEFAULT_DECODER_SETTINGS);
...
describe("JavaFallbackDecoder", () => {
  describe("decode()", () => {
    ...
    const decoder = new JavaFallbackDecoder("java.lang.Object", DEFAULT_DECODER_SETTINGS);
